...
### 3. Build the 16-scene spine
From the synopsis, build a full 16-scene spine: the **scenes**, then the **premise**, **controlling
idea**, **setting**, and **cast**, then **beats + screenplay** for every scene — threading continuity
scene to scene.
