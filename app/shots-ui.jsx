      ...
      _el("div",{className:"art-intro"},
        _el("div",{className:"art-intro-row"},
          _el("div",{style:{flex:1}},
            _el("div",{className:"art-intro-t"},"Shot List"),
            _el("div",{className:"art-intro-d"},
              "Every beat becomes a shot. \u201cDraft all shots\u201d breaks each scene into coverage \u2014 size, angle, "
              +"movement and lens \u2014 then composes each frame from the scene's grade, the location plate and the "
              +"character & prop sheets. Generate the frames here; the Storyboard lays them out next.")),
    ...
    _el("div",{className:"art-intro"},
      _el("div",{className:"art-intro-row"},
        _el("div",{style:{flex:1}},
          _el("div",{className:"art-intro-t"},"Shot List"),
          _el("div",{className:"art-intro-d"},
            "One shot per beat, grouped by scene. Each frame composes the scene's Style Bible grade, the location "
            +"plate and the character & prop sheets into a single image \u2014 so every shot stays on-model and on-palette.")),
        _el("div",{className:"art-intro-actions"},
