      ...
      _sbEl("div",{className:"art-intro"},
        _sbEl("div",{className:"art-intro-row"},
          _sbEl("div",{style:{flex:1}},
            _sbEl("div",{className:"art-intro-t"},"Storyboard"),
            _sbEl("div",{className:"art-intro-d"},
              "Each scene becomes one 3×3 storyboard page — a single image of up to nine panels, generated with GPT Image 2.")))),
    ...
    _sbEl("div",{className:"art-intro"},
      _sbEl("div",{className:"art-intro-row"},
        _sbEl("div",{style:{flex:1}},
          _sbEl("div",{className:"art-intro-t"},"Storyboard"),
          _sbEl("div",{className:"art-intro-d"},
            "Each scene is one 3×3 storyboard page — a single image of up to nine panels, generated in one pass with GPT Image 2. ",
            _sbEl("b",null, readyPages+" of "+totalPages+" page"+(totalPages!==1?"s":"")+" generated"),
            ". Until a page is generated it shows labelled panel guides; click a guide to edit that shot.")),
