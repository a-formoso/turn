...
async function aiDraftShots(scene, beats, drafts, locations, props, characters, project, opts){
  ...
  const prompt = ctx + "\nYou are the director + DP. "+
    (_onlyBeat
      ...
      : ("Break this scene into a SHOT LIST with exactly ONE shot per beat above"+
         (rows.length?"":" (or 3\u20135 shots if no beats are given)")+", in order. "))+
