...
APP_FEATURES.push({ name:"Team collaboration", what:"The Team button in the top bar lets a project owner share the current film with collaborators by email. Collaborator roles are View-only, Writer, Art director, and Producer/admin; shared projects appear in the collaborator's project switcher with a Shared badge, while owner-only actions such as rename and delete stay hidden from collaborators." });
