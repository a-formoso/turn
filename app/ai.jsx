...
if(_charSheetsFeature) _charSheetsFeature.what = _charSheetsFeature.what
  ...
  .replace("(Sheets generated before this format are 10-panel grids; both work as references.)",
    "(Older 10-panel and 4-panel sheets still work as references, but new character sheets use the 3-PANEL casting-reference layout: hero face portrait | HEADLESS full-body front (no head rendered — blank background above the collar, the figure at the SAME height and scale as the back view; exactly ONE face on the sheet, because a second rendered face makes video generators blend or hallucinate identity) | full-body back — deliberately with NO text, info box or character-data panel baked into the image: generators condition on pixels and copy stray text as artifacts, while the character's metadata already reaches every generator as prompt text.)");
