...
function getWritingModelId(task){ try{ const s=localStorage.getItem(WRITING_MODEL_KEY); if(s && WRITING_MODELS.find(m=>m.id===s)) return s; }catch(e){} return recommendedWritingModelId(task); }
