...
APP_FEATURES.push({ name:"A plan is required (no free tier)", what:"Cinema Machine has no free tier. Creating an account is free and you can look around the Writers' Room, but you must be on a plan (Writer $19 / Director $49 / Studio $149 a month, each with a monthly credit allowance) before you can create a story or open any room beyond the Writers' Room — because those steps spend credits on real text and media generation. If you pick a plan on the landing page before signing up, checkout for that plan opens automatically once your account is created (the choice carries through signup). If you try to start a story or open the Art Room / Stage without a plan, the plans window opens so you can choose one. Admins are exempt." });
