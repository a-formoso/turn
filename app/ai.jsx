...
async function aiDraftShots(scene, beats, drafts, locations, props, characters, project, opts){
  ...
  const prompt = ctx + "\nYou are the director + DP. "+
    (_onlyBeat
      ? ("Beat "+_onlyBeat+" needs REAL COVERAGE: design 2-3 shots for THAT BEAT ONLY \u2014 one per distinct visual event, in cut order. "+
