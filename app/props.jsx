    ...
    React.createElement("div",{className:"art-intro"},
      React.createElement("div",{className:"art-intro-row"},
        React.createElement("div",{style:{flex:1}},
          React.createElement("div",{className:"art-intro-t"},"Props"),
          React.createElement("div",{className:"art-intro-d"},
            "Continuity objects \u2014 the things characters wear and carry. Each gets its own multi-view reference sheet so the object stays identical in every shot. ",
            "Generate a prop here first, then reference it when you build the character sheets and shots that feature it.")),
